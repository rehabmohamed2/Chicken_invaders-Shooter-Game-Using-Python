...
def xoo ():
    ...
    topfram.grid(row=0, column=0 ,columnspan=25)
    frame= Frame(gamewindow, bg="#212223", height=150 )
    ...
    def scorekeeper():
        if(button1["text"]=="x" and button2["text"]=="x" and button3["text"]=="x"):
            ...
            score = (n + 1)
            playerx.set(score)
            tkinter.messagebox.showinfo("player x has won", "player x is the winner")
            ...
            score = (n + 1)
            playero.set(score)
            tkinter.messagebox.showinfo("player y has won", "player y is the winner")
    ...
    playeroresult.grid(row=4, column=0, sticky=W)
    ...
    space = Label(downframe, font=("arial", 36, "bold"),text="",  pady=5, padx=2 , bg="#212223")
    space.grid(row=6, column=0, sticky=W)
...
def bingbong():
    ...
    button = Button(canvas.master, text="Back", height=1 , width=20 ,command=main)
    button.pack()
    button.place(x=350, y=500)  # place the button anywhere on the screen
   ...
   # Ball of circle shape  
    ...
    def again():
        ...
        canvas = screen.getcanvas()
        button = Button(canvas.master, text="Back", height=1 , width=20 ,command= openwindow)
        button.pack()
        button.place(x=350, y=500)  # place the button anywhere on the screen
       ...
       #  initialize the score  
        ...
        while True: 
            ...
            if (left_player> right_player and left_player == 10 ):
                ...
                button2 = Button(canvas.master, text="Again", height=1 , width=20 ,command= again)
                button2.pack()
                button2.place(x=350, y=500)  # place the button anywhere on the screen
